...
export const PROCEDURE_NAME_CONTEXT = CypherParser.ProcedureInvocationBodyContext;
export const CONSOLE_COMMAND_NAME_CONTEXT = CypherParser.CypherConsoleCommandNameContext;
export const CONSOLE_COMMAND_CONTEXT = CypherParser.CypherConsoleCommandContext;
export const CONSOLE_COMMAND_PARAMETERS_CONTEXT = CypherParser.CypherConsoleCommandParametersContext;
export const CONSOLE_COMMAND_PARAMETER_CONTEXT = CypherParser.CypherConsoleCommandParameterContext;
export const CONSOLE_COMMAND_SUBCOMMAND_CONTEXT = CypherParser.SubCommandContext;
...
export const SINGLE_FUNCTION_NAME_CONTEXT = CypherParser.SingleFunctionNameContext;
export const NONE_FUNCTION_NAME_CONTEXT = CypherParser.NoneFunctionNameContext;
export const EXTRACT_FUNCTION_NAME_CONTEXT = CypherParser.ExtractFunctionNameContext;
export const REDUCE_FUNCTION_NAME_CONTEXT = CypherParser.ReduceFunctionNameContext;
export const SHORTEST_PATH_FUNCTION_NAME_CONTEXT = CypherParser.ShortestPathFunctionNameContext;
export const ALL_SHORTEST_PATH_FUNCTION_NAME_CONTEXT = CypherParser.AllShortestPathFunctionNameContext;
export const FILTER_FUNCTION_NAME_CONTEXT = CypherParser.FilterFunctionNameContext;
export const EXISTS_FUNCTION_NAME_CONTEXT = CypherParser.ExistsFunctionNameContext;
...
export const RELATIONSHIP_TYPE_OPTIONAL_COLON_CONTEXT = CypherParser.RelationshipTypeOptionalColonContext;
export const RELATIONSHIP_TYPES_CONTEXT = CypherParser.RelationshipTypesContext;
export const RELATIONSHIP_PATTERN_CONTEXT = CypherParser.RelationshipPatternContext;
...
export const COMPLETION_CANDIDATES = [STRING_LITERAL_CONTEXT, VARIABLE_CONTEXT, PROCEDURE_NAME_CONTEXT, FUNCTION_NAME_CONTEXT, CONSOLE_COMMAND_NAME_CONTEXT, NODE_LABEL_CONTEXT, RELATIONSHIP_TYPE_CONTEXT, RELATIONSHIP_TYPE_OPTIONAL_COLON_CONTEXT];
export const SYMBOLIC_CONTEXTS = [VARIABLE_CONTEXT, LABEL_NAME_CONTEXT, RELATIONSHIP_TYPE_NAME_CONTEXT, PROPERTY_KEY_NAME_CONTEXT, PARAMETER_NAME_CONTEXT];