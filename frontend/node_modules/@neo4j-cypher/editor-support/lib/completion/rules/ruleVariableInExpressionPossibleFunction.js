...
var _default = element => {
  const variable = _TreeUtils.TreeUtils.findAnyParent(element, [CypherTypes.VARIABLE_CONTEXT]);
  const expression = _TreeUtils.TreeUtils.findAnyParent(variable, [CypherTypes.EXPRESSION_CONTEXT]);
